...
// set up a reducer that takes in the action.type
// splits it up into different cases
// each case modifies on the inital state and return previous state
// dipatching an action includes a payload which modifies the state speicifed in the reducer function
// the inital state sets up the data structure that going to be modified
